...
class CustomerService {
    ...
    get diningCustomer() {
        ...
        responseDTO.data = this.customerBuffer; //TODO must modify since buffer mode was removed.
        return responseDTO;
    }
     ...
     * Check in.
     */
    checkIn(customerObj, callback) { //TODO must review this method
        var responseDTO = new ResDTO();

        // Check data complete
        if (!customerObj.name || !customerObj.phone || !customerObj.peoplecount || !customerObj.furnish) {
     ...
     * Check out.
     */
    checkOut(customerId, callback) { //TODO must review this method
    }
